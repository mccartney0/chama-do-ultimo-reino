...
const profiles = [
  {
    slug: "kael", number: "01", name: "Kael Auren", role: "O ferreiro da chama azul · Criador de runas", mark: "KA · 19", tone: "blue", image: art.kael, archive: "FERROSUL · TESTEMUNHA DA MEMÓRIA", sigil: "Chama da Memória", instrument: "Grimório vivo · fogo azul · Runa de Equilíbrio", affiliation: "Oficina Auren · Vigília", quote: "A memória não voltou para obedecer. Voltou para ser testemunhada.", summary: "Kael Auren, ferreiro de Ferrosul, evolui no Livro II com a Visão do Fluxo, a Chama Arcana e a criação da Runa de Equilíbrio ao lado de Dheren.", evidence: "FORJA AUREN · PEÇA 19",
    bio: ["Kael cresceu entre o calor controlado das forjas de Ferrosul, sob a orientação silenciosa de Darion Auren. Para ele, o ferro era uma promessa simples: toda matéria cede quando se conhece o tempo e a temperatura certos.", "A chama azul desfez essa certeza. Ela não aquece como o fogo comum, responde como uma lembrança e traz vozes que Kael não pediu para ouvir. Com o grimório vivo em mãos, o jovem ferreiro passa a carregar rastros de Maelis e de uma história que a Coroa preferiria chamar de lenda.", "No Livro II, Kael evolui para além do que Ferrosul poderia ensinar. A Visão do Fluxo permite que ele perceba o movimento da magia antes de ela se manifestar; a Chama Arcana transforma sua forja em laboratório de runas ativas. A Runa de Equilíbrio — criada em parceria com Dheren — e o Regulador Místico preservam espaço para escolha, sem apagar custos ou riscos."],
    regions: [
  ...
  {
    slug: "dharen", number: "02", name: "Dharen Varenn", role: "O Caminhante de Prata · O Sangue do Guerreiro", mark: "DV · 39", tone: "ruby", image: art.dharen, archive: "ESTRADAS · ATRANSFORMAÇÃO RUBRA", sigil: "Lâmina Rubra", instrument: "Espada rúnica · Sentido Vital · Passo Rubro · Drenagem", affiliation: "Caminhante de Prata · Vigília · Casa sem Sol", quote: "A vontade não comanda o homem. Comanda o caminho que ele escolhe.", summary: "Dharen Varenn desperta transformado no Livro II. Fome, Sentido Vital, Passo Rubro e Drenagem — e a Runa de Equilíbrio que preserva espaço para escolha.", evidence: "PRATA VARENN · ROTA 39",
    bio: ["Dharen Varenn aprendeu a sobreviver entre contratos, estradas e promessas que raramente chegam inteiras ao destino. Antes de se tornar o Caminhante de Prata, ele já conhecia o preço de atravessar uma sala sem revelar tudo o que sabia.", "A energia mística e a espada rúnica o tornam perigoso, mas não explicam por que ele escolhe ficar quando seria mais simples partir. Seu passado toca a Coroa e o nome Varenn guarda ausências que ele trata com ironia, como se humor fosse uma lâmina capaz de afastar qualquer culpa.", "O Laço Astral com Kael desloca sua rota. Dharen não recebe a força do ferreiro; recebe a impossibilidade de fingir que o peso do outro não existe. É essa mudança que transforma proteção em testemunho.", "No Livro II, Dheren desperta transformado. A condição que usa os mesmos canais de sua magia dourada traz o Sentido Vital (três corações ao mesmo tempo), o Passo Rubro (atravessar distâncias num passo), a Drenagem como instinto e a fome como rotina. A Runa de Equilíbrio — criada em parceria com Kael — e o Regulador Místico preservam espaço para escolha, sem apagar custos ou riscos. A Lâmina Rubra, estabilizada na Convergência, carrega os dois lados do mesmo caminho."],
    regions: [
  ...
  {
    slug: "sarya", number: "05", name: "Sarya", role: "A voz que recupera a própria história", mark: "SA · 48", tone: "ivory", image: art.lyra, archive: "CASA SEM SOL · REGISTRO 48", sigil: "Memória Recuperada", instrument: "Voz · testemunho", affiliation: "Casa sem Sol · Vigília", quote: "Uma história apagada não deixa de existir. Deixa de ser contada por quem a viveu.", summary: "Sarya recupera parte de sua história apagada no Livro II. Permanece perto da Casa por escolha própria, guardando memórias que o mundo tentou apagar.", evidence: "CASA SEM SOL · REGISTRO 48",
    bio: ["Sarya viveu nas margens da Casa sem Sol — um lugar que não aparece nos mapas oficiais e cuja existência a Coroa prefere ignorar. Sua memória não foi apagada por acidente: foi apagada por decisão de alguém com muito poder e pouca empatia.", "No Livro II, Sarya recupera parte de sua história. Não toda. O suficiente para entender o que lhe foi tirado e o que ainda pode ser feito com o que resta. Sua escolha de permanecer perto da Casa não é resignação: é a forma mais firme de testemunho que ela conhece.", "Sarya não busca vingança. Busca presença. E no mundo de A Chama do Último Reino, presença é o que resiste quando todo o resto tenta ser esquecido."],
    regions: [
      { slug: "casa-dos-ecos", name: "Casa dos Ecos", label: "Memória", image: art.casaDosEcos, text: "O lugar onde as histórias apagadas ainda ecoam." },
      { slug: "casa-sem-sol", name: "Casa sem Sol", label: "Presença", image: art.casaSemSol, text: "O destino da jornada. Um lugar que não aparece nos mapas oficiais." },
    ],
    companions: ["varos"],
    archiveNote: "Sarya não coleciona registros. Ela é um registro que o mundo tentou apagar — e que insiste em existir.",
    bonds: [
      { slug: "varos", person: "Varos", sigil: "VA", label: "Confronto necessário", type: "tensão ética", accent: "ruby", text: "Varos é forçado a confrontar o limite de sua própria filosofia quando viola o consentimento de Dheren e desencadeia a Ruptura. Sarya observa: alguns erros não se resolvem com teoria." },
    ],
  },
  {
    slug: "varos", number: "06", name: "Varos", role: "O filósofo da Ruptura", mark: "VA · 71", tone: "ruby", image: art.mira, archive: "ESTRADAS · ROTEIRO DE RUPTURA", sigil: "Ruptura", instrument: "Filosofia · violação do consentimento", affiliation: "— · Caminhante solo", quote: "Toda filosofia tem um limite. O meu custou o consentimento de alguém que não me pertencia.", summary: "Varos é forçado a confrontar o limite de sua própria filosofia no Livro II quando viola o consentimento de Dheren e desencadeia a Ruptura.", evidence: "ESTRADAS · ROTEIRO DE RUPTURA",
    bio: ["Varos acreditava que toda experiência podia ser analisada, decomposta e compreendida. Era um filósofo de campo: caminhava, observava, registava. Acreditava que o mundo era um texto que qualquer pessoa suficientemente inteligente poderia ler.", "No Livro II, Varos comete o erro que nenhum texto previa: viola o consentimento de Dheren. Não por maldade — por curiosidade. Por achar que a transformação de Dheren era um fenômeno que merecia ser estudado de perto, sem pedir permissão.", "A Ruptura que desencadeia não é apenas um evento físico. É um rompimento de confiança que ecoa por todo o grupo. Varos aprende — tarde, mas aprende — que algumas fronteiras não se cruzam sem destruir algo que não pode ser reconstruído."],
    regions: [
      { slug: "nareth", name: "Nareth", label: "Observação", image: art.nareth, text: "O lugar onde Varos acreditou que podia entender tudo sem participar de nada." },
      { slug: "casa-sem-sol", name: "Casa sem Sol", label: "Consequência", image: art.casaSemSol, text: "O destino da jornada. O lugar onde a Ruptura deixa de ser teoria." },
    ],
    companions: [],
    archiveNote: "Varos registrou tudo. Menos o momento em que entendeu que observar não é o mesmo que ter permissão para intervir.",
    bonds: [
      { slug: "sarya", person: "Sarya", sigil: "SA", label: "Confronto necessário", type: "tensão ética", accent: "ivory", text: "Sarya observa Varos com a paciência de quem já foi apagado uma vez e sabe reconhecer quando alguém está prestes a apagar outra pessoa." },
    ],
  },
] as const;
